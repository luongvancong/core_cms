...
namespace PHPSTORM_META {
    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        ...
        'ImageFactory' => \App\Hocs\Core\Images\ImageFactory::class,
        'Laravel\Socialite\Contracts\Factory' => \Laravel\Socialite\SocialiteManager::class,
        'Modules\Banner\Repositories\BannerRepository' => \Modules\Banner\Repositories\DbBannerRepository::class,
        'Modules\Category\Repositories\CategoryRepository' => \Modules\Category\Repositories\DbCategoryRepository::class,
        'Modules\Menu\Repositories\MenuRepository' => \Modules\Menu\Repositories\DbMenuRepository::class,
        'Modules\Page\Repositories\PageRepository' => \Modules\Page\Repositories\DbPageRepository::class,
        'Modules\Post\Repositories\Category\PostCategoryRepository' => \Modules\Post\Repositories\Category\DbPostCategoryRepository::class,
        'Modules\Post\Repositories\PostRepository' => \Modules\Post\Repositories\DbPostRepository::class,
        'Modules\Product\Repositories\Attribute\ProductAttributeRepository' => \Modules\Product\Repositories\Attribute\DbProductAttributeRepository::class,
        'Modules\Product\Repositories\Attribute\ProductAttributeValueRepository' => \Modules\Product\Repositories\Attribute\DbProductAttributeValueRepository::class,
        'Modules\Product\Repositories\Category\ProductCategoryRepository' => \Modules\Product\Repositories\Category\DbProductCategoryRepository::class,
        'Modules\Product\Repositories\ProductRepository' => \Modules\Product\Repositories\DbProductRepository::class,
        'Modules\Qa\Repositories\AnswerRepository' => \Modules\Qa\Repositories\DbAnswerRepository::class,
        'Modules\Qa\Repositories\QuestionRepository' => \Modules\Qa\Repositories\DbQuestionRepository::class,
        'Modules\Setting\Repositories\SettingRepository' => \Modules\Setting\Repositories\DbSettingRepository::class,
        'Modules\Tag\Repositories\TagRepository' => \Modules\Tag\Repositories\DbTagRepository::class,
        'Modules\Testimonial\Repositories\TestimonialRepository' => \Modules\Testimonial\Repositories\DbTestimonialRepository::class,
        'Modules\User\Repositories\Chmod\PermissionRepository' => \Modules\User\Repositories\Chmod\DbPermissionRepository::class,
