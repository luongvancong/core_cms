<div class="gallery-control">
    <div class="thumnail-container mg-bt-10">
        <img src="{{ old($controlName, parse_image_url('sm_' . $defaultValueControl)) ? parse_image_url('sm_' . old($controlName, $defaultValueControl)) : '/images/no-image.png' }}" class="{{ !old($controlName, $defaultValueControl) ? 'hide' : '' }} img-thumnail" id="{{ $imgId }}">
    </div>
