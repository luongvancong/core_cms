						...
						<tbody>
							@foreach ($roles as $key => $role)
								<tr>
									...
									<td width="30"><a href="{{ route('role.edit', $role->id) }}" class="btn btn-xs btn-default"><i class="fa fa-pencil"></i></a></td>
									<td width="30"><a href="{{ route('role.destroy', $role->id) }}" class="btn btn-xs btn-danger btn-delete-action"><i class="fa fa-trash-o"></i></a></td>
								</tr>
							@endforeach
						</tbody>
					</table>
