...
Route::group([
    ...
    function() {
        ...
        Route::get('/{questionId}/delete', ['as' => 'admin.question.delete',
        ...
        // Tạo câu trả lời
        Route::get('/{questionId}/answer/create', ['as' => 'admin.answer.create',
        ...
        // Sửa câu trả lời
        Route::get('/answer/{answerId}/edit', ['as' => 'admin.answer.edit',
        ...
        // Xóa câu trả lời
        Route::get('/answer/{answerId}/delete', ['as' => 'admin.answer.delete',
